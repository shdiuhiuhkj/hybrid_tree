        ...
        for j in [2]:
            rf = RandomForestClassifier(n_estimators=i,
                                 ...
                                 min_split_gain=-100.0,
                                        istree=True,
                                        w_class=w_class,w_class2=w_class2,
            ...
            can.append([w_class,w_class2,i, j])
...
ddd_dtpd.to_csv(path_result_dt + 'list_'+str(w_class)+'_all_'+str(w_class2)+'_P_2.csv')
...
dfdfa.to_csv(path_result + 'list_'+str(w_class)+'_all_'+str(w_class2)+'_P_2.csv')
